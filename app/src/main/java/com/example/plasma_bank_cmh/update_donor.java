...
public class update_donor extends AppCompatActivity {
    TextView keyTextView, dobTextView, positiveDateTextView, negativeDateTextView;
                ...
                myAlertDialogBuilder.setPositiveButton(
                        ...
                        new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                ...
                                String posDate= String.valueOf(positiveDateTextView.getText());
                                String negDate= String.valueOf(negativeDateTextView.getText());
...
//                                Toast.makeText(getApplicationContext(),"Donor removed from the system.", Toast.LENGTH_LONG).show();
//                                Intent intent2=new Intent(update_donor.this,donorlist.class);
//                                // intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
//                                startActivity(intent2);
                                ...
                                Intent intent=new Intent(update_donor.this,donorlist.class);
                                //intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                                startActivity(intent);
    ...
    private void insertDataIntoViews(String[] stringArray) {
       ...
       // Toast.makeText(getApplicationContext(),"Your mail is"+mail_s,Toast.LENGTH_LONG).show();
