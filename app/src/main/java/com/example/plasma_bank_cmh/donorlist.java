...
public class donorlist extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    TextView coronaNegativeBeforeTextView,lastDonationBeforeTextView;
    EditText coronaNegativeBeforeEditText,lastDonationBeforeEditText;
        ...
        searchButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(serialNoRadioButton.isChecked()){
                    ...
                    String negativeDaysString= String.valueOf(coronaNegativeBeforeEditText.getText()).trim();
