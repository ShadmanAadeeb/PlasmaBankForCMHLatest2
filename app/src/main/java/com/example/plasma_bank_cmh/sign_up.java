...
//                }
                ...
                else
                {
                    ...
                    final user s1=new user(name_s,address_s,phone_s,mail_s,password_s,dob_s,role_s,description_s,"pending");
                   ...
                   // String key=myRef.push().getKey();
                    ...
                    rootRef.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(DataSnapshot snapshot) {
                            ...
                            {
                                Toast.makeText(getApplicationContext(),"Same email already used in the system",Toast.LENGTH_LONG).show();
                            }
                        }
